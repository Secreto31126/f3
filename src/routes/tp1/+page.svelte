...
<div class="grid grid-rows-2 md:grid-cols-2 p-8 items-center h-svh *:w-full">
    <img
    ...
    <form class="flex flex-col items-center justify-center gap-4 *:w-full px-4">
        <div class="flex">
        ...
        <label for="voltage">
            Voltaje: {volts}V
            <br />
            Corriente: {current.toFixed(3)}mA
        </label>
    </form>
</div>
